...
function d(d, e, f, g) {
    var h = {}
        , i = a(16);
    return h.encText = b(d, g),   // b是aes加密, 调用两次aes加密
        h.encText = b(h.encText, i),
        h.encSecKey = c(i, e, f),  // c是rsa加密
        h  // 加密之后的值返回
}


// arg1 = '{"ids":"[2071935674]","level":"standard","encodeType":"aac","csrf_token":""}'
arg2 = '010001'
